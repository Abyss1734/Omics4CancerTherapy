...
correlation_file <- "./mean_expression_by_cancer_type_data.csv"
...
correlation_colors <- colorRamp2(c(0, 3, 6), c("blue", "white", "red"))
...
png("mean_expression_by_cancer_type.png", width = 10, height = 10, units = "in", res = 600)
draw(ht_correlation)
dev.off()
